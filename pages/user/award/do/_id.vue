...
export default {
  ...
  head() {
    return {
      title: this.user.username + ' 的奖励 - 经历网',
      totalData: {}
    }
  },
  async asyncData({params, app, store}) {
    ...
    // 统计-用户微服务
    const {data: userServiceCount} = await app.$statisticCountUser(routeId)
    const count = userServiceCount.count
    return {
      routeId,
      userId,
      user,
